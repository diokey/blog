...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/diokey/blog)

This is a [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/) blog based on [timlrx's starter template](https://github.com/timlrx/tailwind-nextjs-starter-blog).

## Other blogs based on this template

- [Demo Blog](https://tailwind-nextjs-starter-blog.vercel.app/) - Tailwind Nextjs starter blog
